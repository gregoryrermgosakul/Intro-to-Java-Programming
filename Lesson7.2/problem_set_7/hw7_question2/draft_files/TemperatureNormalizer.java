   ...
   */
   ...
   public double getAdjustedAverage()
   {
       ...
       for (int i = 0; i < data.length; i++)
       {
           ...
           {
               count++;
               sumScores = sumScores + data[i];
               adjustedAverage = sumScores / count;
           }
       }
    ...
    */
    public double getMax()
    {
        ...
        double highestSoFar = data[0];
        for (int i = 1; i < data.length; i++)
        {
            if (data[i] > highestSoFar)
            {
                highestSoFar = data[i];
            }
        }
    ...
    */
    public double getMin()
    {
        ...
        double lowestSoFar = data[0];
        for (int i = 1; i < data.length; i++)
        {
            if (data[i] < lowestSoFar)
            {
                lowestSoFar = data[i];
            }
        }
