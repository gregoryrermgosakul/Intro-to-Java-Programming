...
public class WindowShape
{
    ...
    {
        double area = h * w;
        double areaSemi = (Math.PI * Math.pow((w/2),2)) / 2;
        return area + areaSemi;
    }
    
    // TODO: Write a static method that takes the width and height of the rectangle
    // as parameters and returns the area of a rectangle wiht those dimensions 
    // and with a
    // semi-circle on top.
    public static double area(double width, double height)
    {
        double area = width * height;
        double areaSemi = (Math.PI * Math.pow((width/2),2)) / 2;
        return area + areaSemi;
    }
