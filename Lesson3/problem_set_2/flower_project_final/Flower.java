...
public class Flower
{
   ...
   {
       // top petal of flower
       Ellipse petal1 = new Ellipse(this.x+20, this.y, 20, 20);
       petal1.setColor(Color.PINK);
       petal1.fill();
       
       // right petal
       Ellipse petal2 = new Ellipse((x+20)+20, y+20, 20, 20);
       ...
       // left petal
       Ellipse petal4 = new Ellipse(x, y+20, 20, 20);
       petal4.setColor(Color.PINK);
       petal4.fill();
       
       // center of flower
       Ellipse yellowCenter = new Ellipse(x+20, y+20, 20, 20);
       yellowCenter.setColor(Color.YELLOW);
       yellowCenter.fill();
       
       // stem of flower
       Line stem = new Line((x+10)+20,y+60,x+30,y+120);
